...
union() {
	difference() {
		union() {
			path_sweep(path = arc(angle = 45, d = 500, n = 20), shape = [[0, 0], [20, 0], [20, 10], [15, 10], [15, 7], [10, 7], [10, 10], [0, 10], [-10, 10], [-10, 7], [-15, 7], [-15, 10], [-20, 10], [-20, 0]]);
			up(z = 5) {
				fwd(y = 13) {
					right(x = 250.0000000000) {
						sphere(r = 5);
					}
				}
			}
		...
		down(z = 0.5000000000) {
			back(y = 168.2914139223983) {
				right(x = 185.26197667087544) {
					cylinder(h = 11, r = 6.5000000000);
				}
			}
		}
		back(y = 176.7766952966369) {
			right(x = 176.77669529663686) {
				rotate(a = 45) {
